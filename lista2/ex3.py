...
peso (peso de peixes) e verifique se há excesso. Se houver, gravar na variável excesso e na variável multa o valor da multa
que João deverá pagar. Caso contrário mostrar tais variáveis com o conteúdo ZERO.'''

peso = float(input("informe o peso de peixes: "))
if peso > 50:
    multa = 4 * (peso - 50)
    print("excesso de %.2f quilos, multa de R$%.2f"%(peso-50, multa))
else:
    multa = 0
    print("excesso de %.2f quilos, multa de R$%.2f"%(peso-peso, multa))
